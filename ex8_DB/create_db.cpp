...
int main(int argc, char* argv[]) {
   ...
   sqlstr = "CREATE TABLE IF NOT EXISTS usuario (user_name TEXT PRIMARY KEY NOT NULL," \
      "Nombre TEXT NOT NULL, Apellido TEXT NOT NULL," \
      " password TEXT NOT NULL," \
      "fecha_nac TEXT NOT NULL, documento INTEGER PRIMARY KEY NOT NULL);";
   ...
   sqlstr = "CREATE TABLE sensor (id_medida INTEGER PRIMARY KEY NOT NULL," \
      ...
      "Presipitacion REAL NOT NULL, Luz REAL NOT NULL,"\
      "Fecha TEXT NOT NULL );";
